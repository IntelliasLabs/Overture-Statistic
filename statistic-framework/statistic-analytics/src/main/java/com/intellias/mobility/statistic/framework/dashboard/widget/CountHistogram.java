...
public class CountHistogram extends KibanaWidget {

  private static final List<String> jsonPath = List.of("/kibana/panel/countHistogram.json");

  public CountHistogram(List<String> indexes, String field, ObjectMapper objectMapper) {
  ...
  public JsonNode buildPanel(
    ...
    String yLevelUuid = java.util.UUID.randomUUID().toString();
    String xLevelUuid = java.util.UUID.randomUUID().toString();
    ...
    var updatedPanel = panelAsString
        ...
        .replace("xLevelUuid", xLevelUuid)
        .replace("yLevelUuid", yLevelUuid);
